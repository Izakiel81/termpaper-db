...
class TeacherModel {
  static async findAll() {
    const query = `SELECT * from teracher`;
  ...
  static async create(name, surname, patronym, phone) {
    const query = `CALL proc_create_teacher($1::character varying, $2::character varying, $3::character varying, $4::character varying, NULL, $5::character varying)`;
    ...
    try {
      ...
      console.error(
        `Database error creating the teacher ${name}\t ${surname}\t ${patronym}\t ${phone}\t ${class_c}\t:`,
        error,
      );
      throw new Error(
  ...
  static async update(id, name, surname, patronym, phone) {
    const query = `CALL proc_update_teacher($1::integer, $2::character varying, $3::character varying, $4::character varying, $5::character varying, NULL, $6::character varying)`;
    ...
    try {
      ...
      console.error(
        `Database error updating the teacher ${id}\t ${name}\t ${surname}\t ${patronym}\t ${phone}\t ${class_c}\t:`,
        error,
      );
      throw new Error(
